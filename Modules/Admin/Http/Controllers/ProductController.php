...
class ProductController extends Controller { 
    ...
    { 
        ...
        return view('admin::product.index', compact('sub_page_title','result_set','categories','data', 'page_title', 'page_action','html'));
    }
    ...
    public function create(Category $category) 
    {
        ...
        return view('admin::product.create', compact('sub_categories','categories', 'html','category', 'page_title', 'page_action'))->withInput(Input::all());
    }
    ...
    public function edit(Category $category) {
        ...
        return view('admin::product.edit', compact('sub_categories','categories','url','category', 'page_title', 'page_action'));
    }
