       ...
       @include('admin::partials.sidebar')
            ...
            <div class="panel panel-white">
                  ...
                  <div class="panel-heading">
                    <h6 class="panel-title"><b> Vendor {{$heading }}</b><a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                    <div class="heading-elements">
                      <ul class="icons-list">
                      <li> <a type="button" href="{{route('vendorProduct.create')}}" class="btn btn-primary text-white btn-labeled btn-rounded "><b><i class="icon-plus3"></i></b> Add Vendor Product<span class="legitRipple-ripple" ></span></a></li>
                      </ul>
                    </div>
                  </div>
                  </div>
              ...
              <div class="panel-body">
                  <div class="table-toolbar">
                    <div class="row">
                    <form action="{{route('vendorProduct')}}" method="get" id="filter_data">
                      <div class="col-md-2">
