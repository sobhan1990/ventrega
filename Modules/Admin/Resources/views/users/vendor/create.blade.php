      ...
      <div class="panel panel-white"> 
       ...
       <div class="panel panel-flat">
            ...
            <div class="heading-elements">
              <ul class="icons-list">
                <li> <a type="button" href="{{route('vendor')}}" class="btn btn-primary text-white   btn-rounded "> {{$heading??''}}<span class="legitRipple-ripple" ></span></a></li> 
              </ul>
            </div>
          </div> 
        </div>
                     ...
                     <div class="panel-body">
                            ...
                            <div class="profile-content col-md-10">
                                <div class="row">
                                    ...
                                    {!! Form::model($user, ['route' => ['vendor.store'],'class'=>'form-basic ui-formwizard user-form','id'=>'users_form']) !!}
