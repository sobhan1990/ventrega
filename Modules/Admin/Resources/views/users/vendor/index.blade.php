                ...
                <div class="panel panel-flat">
                  <div class="panel-heading">
                    ...
                    <div class="heading-elements">
                      <ul class="icons-list">
                        <li> <a type="button" href="{{route('vendor.create')}}" class="btn btn-primary text-white btn-labeled btn-rounded "><b><i class="icon-plus3"></i></b>Add Vendor<span class="legitRipple-ripple" ></span></a></li> 
                      </ul>
                    </div>
                  </div> 
                </div>  
