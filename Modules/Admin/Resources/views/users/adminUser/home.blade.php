                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                         ...
                                         <div class="col-md-2">
                                             <a href="{{ route('adminUser') }}">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="">
                                        ...
                                        @foreach($users as $key => $result)
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="{{ route('adminUser.edit',$result->id)}}?role_type={{$result->role_type}}">
