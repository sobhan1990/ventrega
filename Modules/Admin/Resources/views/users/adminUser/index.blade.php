            ...
            <div class="panel panel-white"> 
                <div class="panel panel-flat">
                  <div class="panel-heading">
                    <h6 class="panel-title"><b> {{$page_title }} List </b><a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                                    ...
                                    <table class="table table-striped table-hover table-bordered table-responsive" id="">
                                        ...
                                        @foreach($users as $key => $result)
                                            <tr>
                                                ...
                                                <td> 
                                      <a href="{{ route('adminUser.edit',$result->id)}}" class="btn btn-primary btn-xs" style="margin-left: 20px">
                                          <i class="fa fa-edit" title="edit"></i> Edit
                                      </a>

                                      {!! Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$result->id, 'route' => array('adminUser.destroy', $result->id))) !!}
