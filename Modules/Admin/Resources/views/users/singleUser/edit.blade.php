      ...
      <div class="panel panel-white"> 
        <div class="panel panel-flat">
            ...
            <div class="heading-elements">
              <ul class="icons-list">
                <li> <a type="button" href="{{route('singleUser')}}" class="btn btn-primary text-white   btn-rounded "> View {{$page_title??''}}<span class="legitRipple-ripple" ></span></a></li> 
              </ul>
            </div>
          </div> 
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                           ...
                           {!! Form::model($user, ['method' => 'PATCH', 'route' => ['singleUser.update', $user->id],'enctype'=>'multipart/form-data','class'=>
