      ...
      <div class="panel panel-white"> 
        ...
        <div class="panel panel-flat">
                    ...
                    <div class="heading-elements">
                      <ul class="icons-list">
                        <li> <a type="button" href="{{route('user')}}" class="btn btn-primary text-white   btn-rounded "> View {{$page_title}}<span class="legitRipple-ripple" ></span></a></li> 
                      </ul>
                    </div>
                  </div> 
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="portlet-body">
                                        <div class="tab-content">
                                            ...
                                            @include('admin::users.user.personel_info', compact('user'))

                                            {!! Form::close() !!} 
                                            <!-- END PERSONAL INFO TAB --> 
                                            @include('admin::users.user.changeAvtar', compact('user'))
