  ...
  <div class="panel panel-white"> 
    ...
    {!! Form::model($category, ['method' => 'PATCH', 'route' => ['product.update', $category->id],'class'=>'form-basic ui-formwizard user-form','id'=>'form_sample_3','enctype'=>'multipart/form-data']) !!}
        @include('admin::product.form', compact('category'))
    {!! Form::close() !!} 
        <!-- END FORM-->
    </div>
