...
<title>Yellotasker</title>
</head>

<body>
<table id="m_6462014940457833709bodyTable" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" style="background:#f5f9fb;border-collapse:collapse;height:100%!important;margin:0;padding:0;width:100%!important" bgcolor="#f5f9fb">
        <tbody>
          <tr>
            <td id="m_6462014940457833709bodyCell" align="center" valign="top" style="height:100%!important;margin:0;padding:40px 0;width:100%!important">


              <table bgcolor="#ffffff" id="m_6462014940457833709emailBody" border="0" cellpadding="0" cellspacing="0" width="552" style="background:#ffffff;border-collapse:separate;border-radius:8px;border:1px solid #cad7dc">
                <tbody><tr>
                  <td>
                    <table class="m_6462014940457833709tb_properties m_6462014940457833709border_style" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                      <tbody><tr><td><table border="0" cellpadding="0" cellspacing="0" class="m_6462014940457833709flexibleContainer m_6462014940457833709logo-table-cell" style="border-bottom-color:#cad7dc;border-bottom-style:solid;border-bottom-width:1px;border-collapse:collapse" width="552">

  <tbody><tr>
   <td align="center" class="m_6462014940457833709flexibleContainerCell" style="padding-left:32px;padding-right:32px;padding-top:20px; background:#000;" valign="top" width="552">
...
<table border="0" cellpadding="0" cellspacing="0" class="m_6462014940457833709flexibleContainer" style="border-collapse:collapse" width="552">

  <tbody><tr>
   <td align="center" class="m_6462014940457833709flexibleContainerCell" style="padding-left:32px;padding-right:32px;padding-top:20px" valign="top" width="552">
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse" width="100%">
      ...
      <tbody><tr>
       <td class="m_6462014940457833709textContent" style="color:#2a2c2d;font-family:MuseoSans-300,'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-size:16px;line-height:125%;padding-bottom:20px;text-align:Left" valign="top" align="Left">
        <p style="color:#2a2c2d;font-family:MuseoSans-300,'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-size:16px;font-weight:300;line-height:125%;margin:24px 0;padding:0;text-align:Left" align="Left">
         <strong style="font-family:MuseoSans-500,'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-weight:500">Hi {{$content['first_name']}},</strong></p>
<p style="color:#2a2c2d;font-family:MuseoSans-300,'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-size:16px;font-weight:300;line-height:125%;margin:24px 0;padding:0;text-align:Left" align="Left">
      ...
      <tbody><tr>
       <td align="center" class="m_6462014940457833709flexibleContainerCell" style="padding-left:32px;padding-right:32px;padding-top:20px" valign="top" width="552">
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse" width="100%">
          ...
          <tbody><tr>
           <td class="m_6462014940457833709textContent" style="color:#2a2c2d;font-family:MuseoSans-300,'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-size:16px;line-height:125%;padding-bottom:20px;text-align:Left" valign="top" align="Left">
            <table border="0" cellpadding="0" cellspacing="0" class="m_6462014940457833709offer-task-block" style="border-collapse:collapse;margin:16px 0" width="100%">
...
<td class="m_6462014940457833709mobile-30-block">
                <p class="m_6462014940457833709price m_6462014940457833709text-center m_6462014940457833709mobile-text-right" style="color:#2a2c2d;font-family:MuseoSans-500,'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-size:28px;font-weight:500;letter-spacing:-.29px;line-height:28px;margin:24px 0;padding:0;text-align:center;vertical-align:middle" align="center">
                 </p>
</td>
</tr>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="m_6462014940457833709footer" style="border-collapse:collapse;border-top-color:#cad7dc; background:#000; border-top-style:solid;border-top-width:1px" width="100%">
  ...
  <tbody><tr>
   <td align="center" valign="top">
    <table border="0" cellpadding="0" cellspacing="0" class="m_6462014940457833709flexibleContainer" style="border-collapse:collapse" width="552">
      ...
      <tbody><tr>
       <td class="m_6462014940457833709flexibleContainerCell" style="padding-left:32px;padding-right:32px;padding-top:20px" valign="top" width="552">
        <table align="Left" border="0" cellpadding="0" cellspacing="0" class="m_6462014940457833709flexibleContainer" style="border-collapse:collapse" width="236">
...
<table align="Right" border="0" cellpadding="0" cellspacing="0" class="m_6462014940457833709flexibleContainer" style="border-collapse:collapse" width="236">
